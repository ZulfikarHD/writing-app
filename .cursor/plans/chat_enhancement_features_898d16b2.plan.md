---
name: Chat Enhancement Features
overview: "Implement 5 additional chat features: (1) Auto-detect Codex aliases in chat input/responses and link them, (2) Delete chat confirmation dialog, (3) Rename chat from thread list, (4) Real-time chat updates using Laravel Reverb, and (5) Regenerate with different model option."
todos:
  - id: f2-delete-confirm
    content: "F2: Add proper delete confirmation dialog to ChatThreadList"
    status: pending
  - id: f3-rename-inline
    content: "F3: Add inline rename capability to ChatThreadList"
    status: pending
  - id: f5-regenerate-model
    content: "F5: Add regenerate with different model option in ChatWindow"
    status: pending
  - id: f5-backend
    content: "F5: Update regenerate endpoint to accept model parameter"
    status: pending
  - id: f1-backend
    content: "F1: Create codex aliases lookup endpoint"
    status: pending
  - id: f1-composable
    content: "F1: Create useCodexAliasDetection composable"
    status: pending
  - id: f1-input
    content: "F1: Add alias detection to ChatInput with auto-context"
    status: pending
  - id: f1-message
    content: "F1: Add alias linking in ChatMessage content"
    status: pending
  - id: f4-reverb
    content: "F4: Install and configure Laravel Reverb"
    status: pending
  - id: f4-events
    content: "F4: Create broadcast events for chat messages"
    status: pending
  - id: f4-frontend
    content: "F4: Create useChatRealtime composable and integrate"
    status: pending
---
